...
export const SignUp = () => {
  ...
  return (
    <div class="h-full bg-gray-400 rounded-md dark:bg-gray-900 border">
      <div class="mx-auto">
        <div class="flex justify-center px-6 py-7">
          <div class="w-full xl:w-3/4 lg:w-11/12 flex">
            ...
            <div class="w-full lg:w-7/12 bg-white dark:bg-gray-700 p-5 rounded-lg lg:rounded-l-none">
              ...
              <form class="px-8 pt-6 pb-8 mb-4 bg-white dark:bg-gray-800 rounded">
                ...
                <div class="mb-6 text-center">
                  <button
                    class="w-full px-4 py-2 font-bold text-white bg-teal-700 rounded-full hover:bg-blue-700 dark:bg-blue-700 dark:text-white dark:hover:bg-blue-900 focus:outline-none focus:shadow-outline"
                    type="button"
                  >
